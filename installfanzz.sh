...
echo "╚═╝╚═╝  ╚═══╝╚══════╝   ╚═╝   ╚═╝  ╚═╝╚══════╝╚══════╝╚══════╝╚═╝  ╚═╝"
echo -e "${RESET}"
echo -e "${BLUE}𝐎𝐖𝐍𝐄𝐑${RESET}${BLUE}𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑${RESET}"
echo -e "${BLUE}WHATSAPP FANZZ : Unknown${RESET}"
echo -e "${BLUE}YOUTUBE FANZZ : FanzzTY${RESET}"
echo ""
...
echo -e "${BLUE}(𝐀𝐔𝐓𝐎𝐌𝐀𝐓𝐈𝐂) 𝖫ICENSE ANDA BENAR, TERIMAKASIH TELAH MEMBELI LICENSE INI YA${RESET}"
...
echo ""
echo -e "${BLUE}𝐓𝐇𝐄𝐌𝐄 ( 𝐑𝐄𝐌𝐀𝐊𝐄 )${RESET}"
echo "6. ENIGMA PREMIUM PTERODACTYL REMAKE BY RAINSTOREID"
echo ""
echo -e "${BLUE}𝐏𝐓𝐄𝐑𝐎𝐃𝐀𝐂𝐓𝐘𝐋 ( 𝐄𝐃𝐈𝐓 )${RESET}"
...
echo ""
echo -e "${BLUE}𝐃𝐄𝐋𝐄𝐓𝐄 𝐓𝐇𝐄𝐌𝐄 / 𝐀𝐃𝐃𝐎𝐍 ( 𝐏𝐋𝐔𝐆𝐈𝐍𝐒 )${RESET}"
...
if [ ! -f "$BLUEPRINT_FILE" ]; then
    echo -e "${BLUE}𝐃𝐄𝐏𝐄𝐍𝐃 𝐏𝐋𝐔𝐆𝐈𝐍𝐒 𝐁𝐄𝐋𝐔𝐌 𝐃𝐈𝐈𝐍𝐒𝐓𝐀𝐋 𝐒𝐈𝐋𝐀𝐇𝐊𝐀𝐍 𝐈𝐍𝐒𝐓𝐀𝐋𝐋 𝐓𝐄𝐑𝐋𝐄𝐁𝐈𝐇 𝐃𝐀𝐇𝐔𝐋𝐔 𝐃𝐄𝐍𝐆𝐀𝐍 𝐌𝐄𝐌𝐈𝐋𝐈𝐇 𝐎𝐏𝐒𝐈 𝐍𝐎 𝟏𝟏${RESET}"
    exit 1
fi
...
echo -e "${BLUE}NEBULA THEME BERHASIL DI INSTALL${RESET}"
    ;;
     3)
cd /var/www
BLUEPRINT_FILE="/var/www/pterodactyl/blueprint.sh"
...
echo -e "${BLUE}PROSES SELESAI${RESET}"
;;
     7)
# Default URL gambar
...
echo -e "${BLUE}BACKGROUND BERHASIL DI GANTI${RESET}"
    ;;
     9)
        echo -e "${BLUE}HAPUS THEME/ADDON DIPILIH${RESET}"
...
php artisan up
        echo -e "${BLUE}Semua tema dan addon telah dihapus.${RESET}"
        ;;
    8)
...
if [ $? -eq 0 ]; then
    echo -e "${BLUE}BACKROUND ANDA BERHASIL DI HAPUS${RESET}"
else
    echo -e "${RED}TERJADI KESALAHAN SAAT MEMPERBARUI FILE!! SILAHKAN HUBUNGI t.me/FanzzHost UNTUK MEMINTA BANTUAN${RESET}"
fi
 ;;
    5)
     # Masukkan token GitHub langsung di sini
...
echo -e "${BLUE}ADDON COOKIES BERHASIL DI INSTALL${RESET}"
...
bash blueprint.sh
    ...
    12)
        ...
        save_config
        echo -e "${BLUE}Semua animasi telah dimatikan.${RESET}"
        ;;
    13)
...
if [ "$file_count" -eq 2 ]; then
    echo -e "${BLUE}𝐏𝐋𝐔𝐆𝐈𝐍𝐒 𝐓𝐄𝐑𝐒𝐈𝐒𝐀 𝟏 𝐁𝐈𝐀𝐑 𝐓𝐈𝐃𝐀𝐊 𝐄𝐑𝐑𝐎𝐑 𝐈𝐍𝐈 𝐃𝐈𝐁𝐀𝐓𝐀𝐋𝐊𝐀𝐍${RESET}"
    exit 1
else
    ...
    if [ -d "nebula" ]; then
        ...
        echo -e "${BLUE}𝐏𝐋𝐔𝐆𝐈𝐍𝐒 𝐍𝐄𝐁𝐔𝐋𝐀 𝐓𝐄𝐑𝐇𝐀𝐏𝐔𝐒${RESET}"
    else
        # Jika folder nebula tidak ada, tampilkan peringatan
        echo -e "${BLUE}𝐓𝐇𝐄𝐌𝐄 𝐍𝐄𝐁𝐔𝐋𝐀 𝐓𝐈𝐃𝐀𝐊 𝐓𝐄𝐑𝐈𝐍𝐒𝐓𝐀𝐋${RESET}"
    fi
fi
       ;;
15)
...
if [ "$file_count" -eq 2 ]; then
    ...
    if [ -d "slate" ]; then
        ...
        echo -e "${BLUE}𝐏𝐋𝐔𝐆𝐈𝐍𝐒 𝐓𝐄𝐑𝐇𝐀𝐏𝐔𝐒${RESET}"
    else
        # Jika folder nebula tidak ada, tampilkan peringatan
        echo -e "${BLUE}𝐓𝐇𝐄𝐌𝐄 𝐓𝐈𝐃𝐀𝐊 𝐓𝐄𝐑𝐈𝐍𝐒𝐓𝐀𝐋${RESET}"
    fi
fi
;;
16)
...
animate_text "𝐅𝐚𝐧𝐳𝐳 𝐓𝐡𝐞𝐦𝐞 𝐈𝐧𝐬𝐭𝐚𝐥𝐥𝐞𝐫 - 𝐏𝐫𝐨𝐬𝐞𝐬 𝐒𝐞𝐥𝐞𝐬𝐚𝐢"